...
| **Understand correctness checks** | 🔍 [docs/deployment-correctness.md](./docs/deployment-correctness.md) | Image identity logging, digest verification, and cross-env promotion checks |
